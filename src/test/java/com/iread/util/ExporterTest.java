...
//        category.setCat3name("小说_test_cat3");
    ...
    public void clearDb() throws SQLException {
        ...
        String sql = "delete from category where cat1name='小说_test';" +
                "delete from book where title like 'TITLE_test_%';";
    ...
    public void testExportBooks_paperBack() throws IOException, SQLException {
        ...
        Category category = new Category(Species.AMAZON, Category.TYPE_NORMAL, "推理小说", "小说", path, 32422, 2);
        bookPreview.setCategory(category);
        Book book = amazonSpider.fetchBook(bookPreview);
        book.setBookid("BOOKID_TEST");
